...
internal class ProductScreenKtTest {
    ...
    fun uiState_isLoading_showOnlyLoadingComponents() {
        composeTestRule.setContent {
            ProductScreen(uiState = ProductViewModel.UiState.Loading, rememberScaffoldState())
        }
    ...
    fun uiState_isSuccess_showOnlyProductDetailsComponents() {
        composeTestRule.setContent {
            ProductScreen(uiState = ProductViewModel.UiState.Success(ViewProduct()), rememberScaffoldState())
        }
    ...
    fun price_IsVisible_WhenUiStateIsSuccess() {
        composeTestRule.setContent {
            ProductScreen(uiState = ProductViewModel.UiState.Success(ViewProduct(formattedPrice = "$7")), rememberScaffoldState())
        }
